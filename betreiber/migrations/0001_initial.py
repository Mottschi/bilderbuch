    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='verwalter', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Einladung',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='betreiber.buch')),
                ('mandant', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='betreiber.mandant')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='mandant',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='betreiber.mandant'),
        ),
        migrations.AddField(
            model_name='user',
